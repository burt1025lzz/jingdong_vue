<template>
  <div className="position">
    <span className="iconfont position__icon">&#xe619;</span>
    北京理工大学国防科技园2号楼10层
    <span className="iconfont position__notice">&#xe613;</span>
  </div>
  ...
  <div className="icons">
    <div v-for="(item, index) in iconList" :key="index" className="icons__item">
      <img
